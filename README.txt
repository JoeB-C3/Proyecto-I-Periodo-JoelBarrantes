...
* Estudiante: [Insertar su Nombre Completo Aquí]
* Sección: [Insertar Sección Aquí, ej. 11-5 / 11-6]
...
------------------------------------------------------------------------
El entregable se encuentra organizado bajo la estructura estándar de desarrollo web en Flask:

nombre_apellido/             # Carpeta principal del proyecto comprimido
│
├── app.py                   # Servidor central, lógica de control y rutas Flask
├── contactos.xlsx           # Base de datos relacional simulada en Excel
├── README.txt               # Documentación general y manual técnico (este archivo)
│
├── static/                  # Recursos estáticos de la aplicación
│   ├── css/                 # Hojas de estilo estructuradas por módulos
│   │   ├── estilo_index.css       # Estilos para la pantalla de inicio de sesión
│   │   └── estilo_principal.css   # Estilos para el panel principal y formularios
│   ├── js/                  # Lógica del lado del cliente
│   │   └── logica_principal.js    # Control de contadores, filtros y ordenamiento
│   └── img/                 # Recursos gráficos e iconografía del sistema
│       ├── logo_login.png
│       ├── logo_entrada_opcion2.png
│       └── simbolo-de-la-interfaz-de-busqueda.png
│
└── templates/               # Vistas HTML renderizadas mediante Jinja2
    ├── index.html           # Interfaz de acceso seguro (Login)
    ├── principal.html       # Tablero principal y listado general de contactos
    ├── agregar_contacto.html# Formulario estandarizado de registro
    ├── detalle_contacto.html# Ficha interactiva de visualización y edición
    ├── favoritos.html       # Sección dedicada a contactos preferidos
    └── reporte_general.html # Tablero de métricas y resumen estadístico


4. ESTRUCTURA DE LA BASE DE DATOS (EXCEL)
------------------------------------------------------------------------
...
5. FUNCIONALIDADES COMPROBADAS E IMPLEMENTADAS
------------------------------------------------------------------------
...
7. ENTREGABLE FINAL
------------------------------------------------------------------------
Para cumplir estrictamente con los formatos de la rúbrica de entrega, asegúrese de renombrar la carpeta principal siguiendo la nomenclatura oficial solicitada:
Formato: nombre_apellido (ejemplo: juan_perez) y comprímala en formato .ZIP o .RAR antes de subirla a la plataforma institucional de evaluación.

========================================================================
  Desarrollado con altos estándares académicos y de ingeniería web.
========================================================================
